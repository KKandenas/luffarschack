...
import { paths, dbGet, dbSet, dbRemove, dbTransact, dbListen, dbPush, registerPresence } from "./firebase.js?v=51";
import { getGame, DEFAULT_GAME_ID } from "./games/registry.js?v=51";
